...
public class MonteCarloTestNoComments implements IBot{

    private final int totalAllowedTime = 800; //in milliseconds

    private int player = 1; //which player is this bot?
    String botName = "Gemini Ver2.0 (hopefully faster?)";
